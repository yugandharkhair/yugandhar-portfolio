...
export interface ContentIndexSliceDefaultPrimary {
   ...
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index.primary.desc
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
...
export interface ExperienceSliceDefaultItem {
  ...
  /**
   * Time field in *Experience → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.items[].time
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  ...
  /**
   * Desc field in *Experience → Items*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.items[].desc
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  desc: prismic.RichTextField;
}
